...
export function HeroMetaStyleEditor() {
  ...
  useEffect(() => {
    ...
    css.textContent = `
      ...
      .hero-meta-style-options button {
        padding: 11px 12px;
        border: 1px solid rgba(166,109,112,.32);
        border-radius: 14px;
        background: #fff;
        color: #5c383a;
        font-weight: 700;
      ...
      .hero-meta-style-options button.active {
        background: #a66d70;
        color: #fff;
        border-color: #a66d70;
      }
      .preview-phone .phone-meta[data-meta-style="minimal"] span {
        border: 0 !important;
      ...
      .preview-phone .phone-meta[data-meta-style="cards"] {
        gap: 9px !important;
      }
      .preview-phone .phone-meta[data-meta-style="cards"] span {
        border: 0 !important;
      ...
      .preview-phone .phone-meta[data-meta-style="editorial"] {
        gap: 0 !important;
        border-top: 1px solid currentColor;
        border-bottom: 1px solid currentColor;
        padding: 8px 0 !important;
      }
      .preview-phone .phone-meta[data-meta-style="editorial"] span {
        border: 0 !important;
        border-radius: 0 !important;
        background: transparent !important;
        padding: 2px 12px !important;
      }
      .preview-phone .phone-meta[data-meta-style="editorial"] span + span {
        border-left: 1px solid currentColor !important;
      }
      @media (max-width: 760px) {
        .hero-meta-style-options { grid-template-columns: 1fr; }
      }
    `;
  ...
  return createPortal(
    <div className="hero-meta-style-editor">
      <strong>Grafica data e orario</strong>
